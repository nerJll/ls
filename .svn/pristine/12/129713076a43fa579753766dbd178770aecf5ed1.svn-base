...
function WindowOpen(URL, width, height) {
	 ...
	 * scrollbars=yes|no|1|0 是否显示滚动条。默认是
	 * yes。 status=yes|no|1|0 是否添加状态栏。默认是 yes。
	...
	window.open(
		URL,
		"_blank",
		"width=" + width+ ",height=" + height + ",left=" + left + ",top=" + top + ",channelmode=yes,directories=no,fullscreen=yes,location=no,menubar=no,resizable=no,scrollbars=yes,status=no,titlebar=yes,toolbar=no",
		false
	);
}
