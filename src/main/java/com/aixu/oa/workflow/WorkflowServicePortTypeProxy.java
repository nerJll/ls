...
public class WorkflowServicePortTypeProxy implements com.aixu.oa.workflow.WorkflowServicePortType {
  private String _endpoint = null;
  private com.aixu.oa.workflow.WorkflowServicePortType workflowServicePortType = null;
  ...
  private void _initWorkflowServicePortTypeProxy() {
    try {
      workflowServicePortType = (new com.aixu.oa.workflow.WorkflowServiceLocator()).getWorkflowServiceHttpPort();
      if (workflowServicePortType != null) {
        if (_endpoint != null)
          ((Stub)workflowServicePortType)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((Stub)workflowServicePortType)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
  ...
  public com.aixu.oa.workflow.WorkflowServicePortType getWorkflowServicePortType() {
    if (workflowServicePortType == null)
      _initWorkflowServicePortTypeProxy();
