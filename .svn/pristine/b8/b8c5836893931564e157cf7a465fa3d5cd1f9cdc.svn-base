...
public class WorkflowDetailTableInfo  implements java.io.Serializable {
    ...
    private com.aixu.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords;
    ...
    public WorkflowDetailTableInfo(
           ...
           com.aixu.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
     ...
     */
    public com.aixu.oa.workflow.WorkflowRequestTableRecord[] getWorkflowRequestTableRecords() {
        return workflowRequestTableRecords;
    }
     ...
     */
    public void setWorkflowRequestTableRecords(com.aixu.oa.workflow.WorkflowRequestTableRecord[] workflowRequestTableRecords) {
        this.workflowRequestTableRecords = workflowRequestTableRecords;
    }
