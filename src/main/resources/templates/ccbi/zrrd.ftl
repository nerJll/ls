		...
		<table id='tb2' class='table table-bordered'>
			...
			<#list 1..3 as i>
				<tr>
					<td>${i}</td>
					<td>
					<input name='zrrdZrbm' type='text' class='form-control'></td>
					<td><input name='zrrdZrr' type='text' class='form-control'></td>
					<td>
					<textarea rows="5" cols="20" name='zrrdYl1' class='form-control'>
					</textarea></td>
					<td>
					<textarea rows="5" cols="20" class='form-control' readonly>
					</textarea></td>
				</tr>
			</#list>
		 </table>
