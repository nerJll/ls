/*******************************************************************************
 * 
 * Plug-in:友好的页面加载效果 Author:sqinyang (sqinyang@sina.com) Time:2015/04/20
...
jQuery.bootstrapLoading = {
	start : function(options) {
		...
		var _LoadingHtml = '<div id="loadingPage" style="position:fixed;left:0;top:0;_position: absolute;width:100%;height:'
				...
				+ ';border-width:'
				+ options.borderWidth
				+ 'px; height:180px; width:180px; line-height:80px; padding-left:80px; padding-right: 5px;border-radius:10px;  background: '
				+ options.backgroundColor
				+ ' url(' + propath() + '/images/loading1.gif)' + ' no-repeat 5px center; color:'
				+ options.TipsColor
				+ ';font-size:20px;">'
