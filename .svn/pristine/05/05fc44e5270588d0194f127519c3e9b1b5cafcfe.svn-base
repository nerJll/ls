		...
		<table id='tb1' class='table table-bordered'>
			...
			<tr>
				...
				<input name='productDesc' type='text' class='form-control' 
						value='${aixuLawsuiDetail.productDesc!""}' readonly>
				</td>
				<td>
				<input name='badReason' type='text' class='form-control' 
						value='${aixuLawsuiDetail.badReason!""}' readonly>
				</td>
				<td>
				<input name='innerStrategy' type='text' class='form-control' 
		...
		<table id='tb2' class='table table-bordered'>
			...
			<#list aixuZrrds as aixuZrrd>
				<tr>
					...
					<td><input name='zrrdZrr' value='${aixuZrrd.zrrdZrr!""}' type='text' class='form-control' readonly></td>
					<td><input name='zrrdYl1' value='${aixuZrrd.zrrdYl1!""}' type='text' class='form-control' readonly></td>
					<td><input name='zrrdClyj' type='text' class='form-control' readonly></td>
				</tr>
			</#list>
		 </table>
		</form>
